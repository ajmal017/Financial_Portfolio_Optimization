...
?>
        ...
        <li>
          <a href="#3" data-toggle="tab">Fundamentals</a>
        </li>
        <li>
          <a href="#4" data-toggle="tab" onClick="portfolioTrans(<?php echo $pflo_id; ?>)">Transaction</a>
        </li>
      </ul>
...
?>
        ...
        <div class="tab-pane" id="4">
		  ...
		  <button onclick="calER()">get average return</button>
